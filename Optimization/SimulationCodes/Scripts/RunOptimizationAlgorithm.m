...
if continueOptimization
    optimizationFolder      = [pwd,'\OptimizationResults\Optimization5Construction'];
    initialIteration        = 20;
...
SteepestDescendOptions.designFactors                            = { 'LFFactor';                     % Model parameter factors that will be used as design variables for the optimization procedure
                                                                    ...
                                                                    'IFFactor'
                                                                    'ITFactor'};
SteepestDescendOptions.optimizationName                         = 'OptimizationX';   	% Name of the folder that the optimization results will be saved
