...
%% Generate workspace
clear
GenerateWorkspaceOfOptimization1_in3
...
SteepestDescendOptions.designFactors                            = { 'LFFactor';                     % Model parameter factors that will be used as design variables for the optimization procedure
                                                                    ...
                                                                    'IFFactor'
                                                                    'ITFactor'};
SteepestDescendOptions.optimizationName                         = 'Optimization1NoConstruction_in3';   	% Name of the folder that the optimization results will be saved
