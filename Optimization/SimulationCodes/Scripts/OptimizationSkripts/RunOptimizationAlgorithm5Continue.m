%% RunOptimizationAlgorithm 5 continue with different optimization parameters
...
%% Generate workspace
clear
GenerateWorkspaceOfOptimization5
...
if continueOptimization
    optimizationFolder      = 'C:\Projects\BipedProjectV2\Optimization\SimulationCodes\OptimizationResults\Optimization5Construction';
    initialIteration        = 50;
...
ConstraintDeviation.lFFactor    = 0.2;
ConstraintDeviation.lTFactor    = 0.2;
ConstraintDeviation.lTxFactor   = 0.2;
ConstraintDeviation.mFFactor    = 0.2;
ConstraintDeviation.mTFactor    = 0.2;
ConstraintDeviation.IFFactor    = 0.2;
ConstraintDeviation.ITFactor    = 0.2;
...
CostFunctionOptions.constructionMassDesired                     = 6.5;
...
CostFunctionOptions.minFootClearancePenaltyFactor               = 5e-2;                           % Weight of the minimum foot clearance to the total cost function
...
SteepestDescendOptions.designFactors                            = { 'LFFactor';                     % Model parameter factors that will be used as design variables for the optimization procedure
                                                                    ...
                                                                    'IFFactor'
                                                                    'ITFactor'};
SteepestDescendOptions.optimizationName                         = 'Optimization5Construction';   	% Name of the folder that the optimization results will be saved
