...
if continueOptimization
    optimizationFolder      = 'C:\Projects\BipedProject\Optimization\SimulationCodes\OptimizationResults\Optimization2NoConstruction';
    initialIteration        = 4;
...
SteepestDescendOptions.designFactors                            = { 'lTxFactor';                    % Model parameter factors that will be used as design variables for the optimization procedure
                                                                    'mFFactor'
                                                                    'lFFactor'
                                                                    'IFFactor'};
SteepestDescendOptions.optimizationName                         = 'Optimization2NoConstruction';   	% Name of the folder that the optimization results will be saved
...
mkdir(['C:\Projects\BipedProject\Optimization\SimulationCodes\OptimizationResults\',SteepestDescendOptions.optimizationName])
save(['C:\Projects\BipedProject\Optimization\SimulationCodes\OptimizationResults\',SteepestDescendOptions.optimizationName,filesep,'OptimizationOptions'],'OptimizationOptions')
