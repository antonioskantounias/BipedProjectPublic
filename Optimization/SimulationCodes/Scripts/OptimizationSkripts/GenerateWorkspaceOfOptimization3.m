...
% Masses
parametersModelFactors.mFFactor     = 0.050917430063259;
parametersModelFactors.mTFactor     = 0.031160000000000;

parametersModelFactors.IHFactor     = 0;
parametersModelFactors.IFFactor     = 0.144181924482512;
parametersModelFactors.ITFactor     = 0.149296027720420;

parametersModelFactors.LFFactor     = 0.289298466195288;
parametersModelFactors.lFFactor     = 0.272758330128138;
parametersModelFactors.lTFactor     = 0.478835453030838;
parametersModelFactors.lTxFactor    = 0.062063815448343;
...
initialConditions.q     = [-0.084299337051496,-0.006113623637576,0.126302207666981,0.060052770270587];
initialConditions.qd    = [-0.103898405357270,-0.003100971959815,-0.187424802637403,-0.366970634500627]* sqrt(g/Lall);