...
if continueOptimization
    optimizationFolder      = 'C:\Projects\BipedProject\Optimization\SimulationCodes\OptimizationResults\Optimization3Construction';
    initialIteration        = 50;
...
CostFunctionOptions.constructionMassPenaltyFactor               = 5e-2;                             	
CostFunctionOptions.constructionMassDesired                     = 8;
...
SteepestDescendOptions.designFactors                            = { 'LFFactor';                     % Model parameter factors that will be used as design variables for the optimization procedure
                                                                    ...
                                                                    'IFFactor'
                                                                    'ITFactor'};
SteepestDescendOptions.optimizationName                         = 'Optimization3Construction';   	% Name of the folder that the optimization results will be saved
