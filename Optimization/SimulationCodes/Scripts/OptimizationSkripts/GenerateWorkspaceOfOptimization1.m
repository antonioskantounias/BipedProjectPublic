...
parametersModelFactors.ITFactor     = [0.257375211083346];

parametersModelFactors.LFFactor     = [0.303180041448850];
...
initialConditions.q     = [-0.084861073553056,-0.006936326723677,0.114699017884450,-0.001331185254248];
initialConditions.qd    = [-0.077784044015894,-0.002429686065718,0.354099698023514,0.010141636170594]* sqrt(g/Lall);