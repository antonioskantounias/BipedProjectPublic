function [value,isterminal,direction] = HS_leg1(t,x,parametersModel)
...
phi=interp1(footshape.psi,footshape.fi,thetaT);
ri=interp1(footshape.psi,footshape.r,thetaT);

height=c1y_calc(L1F,L1T,ksiF,ksiT,l1,l2,l3,l4,l5,l6,thetaF,thetaK,yH);
touch=sin(-thetaT-phi)*ri;
value=height-touch;
