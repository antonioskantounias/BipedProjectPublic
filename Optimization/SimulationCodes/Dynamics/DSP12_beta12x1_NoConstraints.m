function [matrix_B] = DSP12_beta12x1_NoConstraints(t,x,parameters,footshape)
...
lamdaMatrix     = Lamda_J(x,parameters,footshape);
lamdaMatrixDot  = Lamda_dot_J(x,parameters,footshape);
