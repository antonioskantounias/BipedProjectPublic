function [xImpact, isImpactValid, lamdas4x1] = calculateImpactSSP1_DSP12(x,parametersModel)
%% calculateImpactSSP1_DSP12 
% Description:  This function takes the state of the model one timestep of before the impact that leads in double stance phase.
