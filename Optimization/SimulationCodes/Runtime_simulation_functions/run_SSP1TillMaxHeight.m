function results = run_SSP1TillMaxHeight(simulationParameters,options,results)
%% run_SSP1TillMaxHeight 
...
if results.fell==0
    ...
    try
        ...
        [tMaxHeightLeg1,xMaxHeightLeg1] = ode15s(@(ti,xi)  SSP_beta14x1(ti,xi,parametersModel), parametersSolver.tspan, results.intermediate.xinit, options.optMaxHeight1);
