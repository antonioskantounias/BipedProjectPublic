function results = run_SSP2TillMaxHeight_GC(simulationParameters,options,results)
...
if results.fell==0
    ...
    try
        ...
        [tMaxHeightLeg2,xMaxHeightLeg2] = ode15s(@(ti,xi)  SSP_beta14x1(ti,xi,parametersModel)+xElegxos4x1(xi,2,parametersModel), parametersSolver.tspan, results.intermediate.xinit, options.optMaxHeight2);
