function results = run_SSP2(simulationParameters, options, results)
%% run_SSP2 
...
if results.fell==0
    ...
    try 
        ...
        [t2,x2] = ode15s(@(ti,xi)  SSP_beta14x1(ti,xi,parametersModel), parametersSolver.tspan, results.intermediate.xinit, options.opt_SSP2);
